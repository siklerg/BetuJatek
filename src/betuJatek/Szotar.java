...
public class Szotar {
	...
	private static String[] alap = { "add", "adj", "adó", "adu", "aha", "aki", "akt", "alá", "áld", "alj", "áll", "ama",
			...
			"vív", "víz", "von", "zab", "zaj", "záp", "zár", "zen", "zöm", "zug", "zúg", "zúz", "zűr" };

	private static String[] ragozott = { "ága", "ágú", "ára", "árú", "azt", "edd", "égi", "éke", "éle", "éli", "élj",
	...
	private static String[] ragok = { "hez", "höz", "nak", "nek", "pre", "pro", "tól", "től", "val", "vel", "bel",
			"kül" };

	private static String[] nevek = { "aba", "ada", "ady", "ali", "áta", "bán", "bea", "bük", "cák", "dég", "dóc",
			"don", "écs", "éda", "ede", "erk", "eta", "ete", "éva", "gál", "göd", "ida", "ila", "iza", "ják", "jen",
			"jób", "kál", "kám", "kup", "lad", "lea", "lél", "leó", "lia", "mád", "mia", "noé", "odó", "ond", "ózd",
			"örs", "pat", "pér", "tab", "tác", "tas", "tás", "tás", "teó", "tés", "ukk", "úny", "usa", "vác", "vál",
			"vát", "vép", "vid", "zia", "zoé"};

	private static String[] roviditesek = { "ápr", "ari", "ati", "aug", "bel", "biz", "ctg", "dec", "dkg", "doc", "feb",
			"gif", "jan", "jpg", "júl", "jún", "kft", "khz", "lsd", "max", "mHz", "nov", "okt", "ovi", "pdf", "phd",
			"rgb", "sim", "sin", "sos", "stb", "tel", "tnt", "tsa", "tsz", "txt", "vki", "vmi", "zrt" };

	private static ArrayList<String> alapSzotar = new ArrayList<String>(Arrays.asList(alap));

	private static ArrayList<String> ragozottSzotar = new ArrayList<String>(Arrays.asList(ragozott));
	private static ArrayList<String> ragokSzotar = new ArrayList<String>(Arrays.asList(ragok));
	private static ArrayList<String> nevekSzotar = new ArrayList<String>(Arrays.asList(nevek));
	private static ArrayList<String> roviditesekSzotar = new ArrayList<String>(Arrays.asList(roviditesek));

	public Szotar() {
		super();
	}

	public static ArrayList<String> getAlapSzotar() {
		return alapSzotar;
	}

	public static void setAlapSzotar(ArrayList<String> alapSzotar) {
		Szotar.alapSzotar = alapSzotar;
	}

	public static ArrayList<String> getRagozottSzotar() {
		return ragozottSzotar;
	}

	public static void setRagozottSzotar(ArrayList<String> ragozottSzotar) {
		Szotar.ragozottSzotar = ragozottSzotar;
	}

	public static ArrayList<String> getRagokSzotar() {
		return ragokSzotar;
	}

	public static void setRagokSzotar(ArrayList<String> ragokSzotar) {
		Szotar.ragokSzotar = ragokSzotar;
	}

	public static ArrayList<String> getNevekSzotar() {
		return nevekSzotar;
	}

	public static void setNevekSzotar(ArrayList<String> nevekSzotar) {
		Szotar.nevekSzotar = nevekSzotar;
	}

	public static ArrayList<String> getRoviditesekSzotar() {
		return roviditesekSzotar;
	}

	public static void setRoviditesekSzotar(ArrayList<String> roviditesekSzotar) {
		Szotar.roviditesekSzotar = roviditesekSzotar;
	}
